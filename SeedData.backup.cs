...
// РЕЗЕРВНАЯ КОПИЯ SeedData — сохранена перед очисткой для тестирования
// ChatId: 454887189 (админ)
// Если данные пропадут после деплоя — скопировать содержимое обратно в SeedData.cs
...
public static class SeedData
{
    ...
    public static async Task SeedAsync(AppDbContext db)
    {
        ...
        if (await db.BotSettings.AnyAsync(x => x.ChatId == ChatId))
            return;
